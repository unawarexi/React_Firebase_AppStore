    ...
    >
      ...
      >
        ...
        <form className="space-y-4">
          <div>
            <label className="block text-gray-600 mb-1">Group Name</label>
            <input 
              type="text" 
          ...
          <div>
            ...
            <textarea 
              className="w-full bg-gray-100 text-gray-900 rounded-lg p-3 focus:ring-2 focus:ring-blue-500 focus:outline-none h-24"
              placeholder="What's your group about?"
            ></textarea>
          </div>
          <div>
            <label className="block text-gray-600 mb-1">Privacy</label>
            <select className="w-full bg-gray-100 text-gray-900 rounded-lg p-3 focus:ring-2 focus:ring-blue-500 focus:outline-none">
          ...
          <div className="pt-2 flex space-x-3">
            <button 
              type="button" 
              className="bg-gray-100 hover:bg-gray-200 text-gray-900 rounded-lg py-3 px-6 w-1/2 transition-colors"
              onClick={() => setShowCreateGroup(false)}
            >
              Cancel
            </button>
          ...
          >
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <div 
                  className="bg-gray-100 rounded-full py-2 px-4 flex-grow text-gray-500"
                >
                  What's on your mind?
                </div>
              </div>
            ...
            >
              <div className="flex justify-between items-center mb-3">
                <h3 className="font-bold text-gray-900 text-lg">Your Groups</h3>
                <button 
              ...
              <div className="grid grid-cols-2 gap-3">
                {groups.map(group => (
                  <div 
                    key={group.id}
                    className="bg-gray-100 rounded-lg p-3 flex items-center space-x-3 cursor-pointer hover:bg-gray-200 transition-colors"
                  >
