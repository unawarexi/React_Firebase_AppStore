...
const FooterCategory = ({ title, links }) => {
  return (
    ...
    >
      <h2 className="title-font font-medium text-gray-900 tracking-wider text-sm mb-3">
        {title}
      </h2>
      <nav className="list-none mb-8">
        {links.map((link, index) => (
          <li key={index}>
            <a className="text-gray-600 hover:text-gray-800 text-sm transition-colors duration-200">
              {link}
            </a>
          </li>
        ))}
...
const StoreBadge = ({ store, Icon, text }) => {
  return (
    <motion.a 
      className="flex items-center justify-center bg-black text-white rounded-lg px-3 py-2 mx-2 mb-2 sm:mb-0"
    ...
    <footer className="text-gray-600 body-font bg-white">
      ...
      >
        ...
        <motion.div 
          ...
          variants={itemVariants}
        >
          <h2 className="text-lg md:text-xl font-bold mb-4">Download Our App</h2>
      ...
      <div className="bg-gray-100">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p className="text-gray-500 text-sm text-center sm:text-left">
            ...
            <a href="#" className="text-gray-600 ml-1" target="_blank" rel="noopener noreferrer">
              All rights reserved
            </a>
          </p>
